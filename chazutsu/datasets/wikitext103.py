...
class WikiText103(Dataset):
    ...
    def __init__(self):
        super().__init__(
            ...
            download_url="https://s3.amazonaws.com/research.metamind.io/wikitext/wikitext-103-v1.zip",  # noqa
            description="The dataset for language modeling that is larger than PTB (over 110 times)."  # noqa
            )
